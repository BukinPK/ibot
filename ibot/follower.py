    ...
    def checkInfo(self):
        ...
        if self.is_media_homeless is True or \
            ...
            #self.is_business is True:
                with open(os.path.join(basedir, 'bot_data', 'bad_user'),
                          'a') as f:
                    f.write(str(self.id)+'\n')
                return False
        else: return True
    ...
    def randomPicLike(self):
        ...
        for like in range(like_count):
            ...
            if media_choice['has_liked'] is True:
                ...
                with open(os.path.join(basedir, 'bot_data', 'pic_like'),
                          'a') as f:
        ...
        for page in range(pages):
            ...
            for like in self.liked:
                if like in self.all_likes:
                    ...
                    print('I liked [', self.like, '] of user: ', self.username,
                        sep='', end='')
                    return False
